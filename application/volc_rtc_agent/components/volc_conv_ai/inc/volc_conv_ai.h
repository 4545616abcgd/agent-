...
typedef enum {
    ...
    VOLC_EV_CONNECTED,            // 本地设备成功加入 RTC 房间
    VOLC_EV_DISCONNECTED,         // 本地设备断开 RTC 房间
    VOLC_EV_REMOTE_USER_JOINED,   // 远端智能体加入 RTC 房间
    VOLC_EV_REMOTE_USER_OFFLINE,  // 远端智能体离开 RTC 房间
    VOLC_EV_TOKEN_EXPIRED,
    VOLC_EV_LICENSE_WARNING,
